...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link href="{{ asset('semantics/components/modal.css') }}" rel="stylesheet">
        ...
        <script src="{{ asset('static/dist/semantic-ui/semantic.min.js') }}"></script>
         <script src="{{ asset('semantics/components/modal.js') }}"></script>
    ...
    <a class="item" href="{{ route('staff.create') }}">
      <i class="smile icon"></i> Register New Member
    </a>
    <a class="item" href="{{ route('staff.print') }}">
      <i class="print icon"></i> Print ID Card
    </a>
    </div>
